            ...
            <div id="control-bar" className={controlsCollapsed ? 'collapsed' : ''}>
                ...
                <div style={{ display: 'inline-block', marginLeft: 12, padding: '6px', border: '1px solid #444', borderRadius: 6 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4, marginTop: 6 }}>
                        <label style={{ fontSize: 12, fontWeight: 600 }}>Filtro de ruído · áreas permitidas para rachaduras</label>
                        ...
                        <div style={{ fontSize: 10, opacity: 0.6 }}>
                            Este filtro limita onde as rachaduras procedurais aparecem. Ajuste e pressione Regenerate para aplicar.
                        </div>
                    </div>
                </div>
